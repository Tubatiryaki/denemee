...
select sirketler_tablosu.sirket_isim, siparisler_tablosu.siparis_id, siparisler_tablosu.siparis_tarihi, siparisler_tablosu.sirket_id
from sirketler as sirketler_tablosu
inner join siparisler as siparisler_tablosu
on sirketler_tablosu.sirket_id = siparisler_tablosu.sirket_id;
...
-- on komutu ile her iki tabloda da ortak olan sütunu eşleştiriyoruz.

-- inner join ile 2 tablodaki ortak olan datalar getirdik.
...
-- SATIS ve MUDURLUK bolumlerinde calisan personelin maaslari 2000'den buyuk olanlarinin

order by B.bolum_isim, P.personel_isim;
-- bolum ve maas bilgilerini bolume ve isme gore siralayara
