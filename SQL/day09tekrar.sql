...
-- Şirketlerde 2000$ dan fazla olan minumum maaşları listeleyiniz.
...
-- Her eyalette 3000$ altındaki maksimum maaşları listeleyiniz.





-- UNION Operator: 1) iki sorgunun sonucunu birleştirmek için kullanılır.
--                 2)UNION Operatorü benzersiz kayıtları getirir. Eğer tekrar eden kayıt varsa tekrarları vermez.


-- Maaşın 3000$ fazla olan eyaletleri ve 2000$ az alan çalışanları listeleyiniz.


-- Tekrar eden datalarıd görmek istersem UNION ALL kulanırız.