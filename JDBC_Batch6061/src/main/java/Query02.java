...
public class Query02 {
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/okul?serverTimezone=UTC", "root", "sifre");

        Statement st = con.createStatement();

        /*
        SORU 01: ÖĞRENCİLER TABLOSUNDAKİ ERKEK ÖĞRENCİ BİLGİLERİ GETİRİN
        */
        ...
        /*
        SORU 02: ÖĞRENCİLER TABLOSUNDAKİ  9 SINIF KIZ ÖĞRENCİ BİLGİLERİ GETİRİN
        */
