...
public class RunnerSave03 {
	...
	public static void main(String[] args) {
		...
		//hibernate.cfg.xml içinde mapping class ile eklenmiþsea þaðýdaki satýra ihtiyaç yok.
		//ikisinden biri kullanýlabilir.
		...
		//Kaydetmek istedðim objeler burada kaydedilecek.
